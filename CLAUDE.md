...
## Git & GitHub (CRITICAL)
Git is already initialized and the remote is configured to push to `electric-apps/electric-ebb321b1`.
The GitHub repo has been created at: https://github.com/electric-apps/electric-ebb321b1
...
```bash
git add -A
git commit -m "chore: scaffold electric-ebb321b1"
...
- Do NOT push to any repository other than `electric-apps/electric-ebb321b1`
